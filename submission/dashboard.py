...
def corr_scatter_graph(df):
    with st.expander("Air Quality VS Temperature"):
        ...
        ax1.scatter(df['TEMP'], df['PM2.5'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax1.set_xticklabels([])
        ax1.set_yticklabels([])
        ...
        ax2.scatter(df['TEMP'], df['PM10'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax2.set_xticklabels([])
        ax2.set_yticklabels([])
        ...
        ax3.scatter(df['TEMP'], df['SO2'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax3.set_xticklabels([])
        ax3.set_yticklabels([])
        ...
        ax4.scatter(df['TEMP'], df['NO2'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax4.set_xticklabels([])
        ax4.set_yticklabels([])
        ...
        ax5.scatter(df['TEMP'], df['CO'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax5.set_xticklabels([])
        ax5.set_yticklabels([])
        ...
        ax6.scatter(df['TEMP'], df['O3'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax6.set_xticklabels([])
        ax6.set_yticklabels([])
    ...
    with st.expander("Air Quality VS Pressure"):
        fig1, ax1 = plt.subplots(figsize=(16, 8))
        ax1.scatter(df['PRES'], df['PM2.5'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax1.set_xticklabels([])
        ax1.set_yticklabels([])
        ...
        fig2, ax2 = plt.subplots(figsize=(16, 8))
        ax2.scatter(df['PRES'], df['PM10'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax2.set_xticklabels([])
        ax2.set_yticklabels([])
        ...
        fig3, ax3 = plt.subplots(figsize=(16, 8))
        ax3.scatter(df['PRES'], df['SO2'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax3.set_xticklabels([])
        ax3.set_yticklabels([])
        ...
        fig4, ax4 = plt.subplots(figsize=(16, 8))
        ax4.scatter(df['PRES'], df['NO2'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax4.set_xticklabels([])
        ax4.set_yticklabels([])
        ...
        fig5, ax5 = plt.subplots(figsize=(16, 8))
        ax5.scatter(df['PRES'], df['CO'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolors= "#ed7d53")
        ax5.set_xticklabels([])
        ax5.set_yticklabels([])
        ...
        fig6, ax6 = plt.subplots(figsize=(16, 8))
        ax6.scatter(df['PRES'], df['O3'],s = 400, alpha = 0.5, c = "#1e2be3",marker = 'o', edgecolor= "#ed7d53")
        ax6.set_xticklabels([])
        ax6.set_yticklabels([])
...
if (option == "1 Day") :
    ...
    with st.container():
        st.header("Air Polution Particulate Matter in Guanyuan")
